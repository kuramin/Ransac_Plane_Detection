...
int main(int argc, char** argv)
{
	...
	vector<vector<Scan_Point*>> mat_p_scp = TXTReader::Read_point_PTX_to_matrix_of_pointers(filePath);
	...
	TXTWriter::WritePointPointersPTX("Result_" + filePath, planars_vec); // and save it to a file
